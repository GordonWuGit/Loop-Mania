...
import unsw.loopmania.goal.GoalBuilder;
...
public abstract class LoopManiaWorldLoader {
    ...
    public LoopManiaWorld load() {
        ...
        Goal goal = allGoals.build(json.getJSONObject("goal-condition"));
    ...
    private void loadEntity(LoopManiaWorld world, JSONObject currentJson, List<Pair<Integer, Integer>> orderedPath) {
        ...
        case "hero_castle":
            ...
            HerosCastle hero_castle = new HerosCastle(xCoord, yCoord);    
            world.addEntity(entity);
            world.setHerosCastle(hero_castle);
